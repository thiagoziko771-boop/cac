                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4">
                    <div class="flex items-start">
                        ...
                        <div class="text-sm">
                            ...
                            <p class="text-yellow-700">O PIX será processado em nome de <strong>CREDPAG VENDAS COMERCIAL LTDA</strong>, empresa responsável pelo processamento de pagamentos do Exército Brasileiro.</p>
                        </div>
                    </div>
                </div>
            </div>
